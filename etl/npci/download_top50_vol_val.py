#!/usr/bin/env python3
"""Download UPI top-50 member banks by volume and value from NPCI."""
import json
import time
...
out_dir = Path(__file__).parent / "raw_top50_vol_val"
...
combined = Path(__file__).parent / "all_top50_vol_val.json"
