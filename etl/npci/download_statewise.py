#!/usr/bin/env python3
"""Download UPI state-wise statistics from NPCI."""
import json
import time
...
out_dir = Path(__file__).parent / "raw_statewise"
...
combined = Path(__file__).parent / "all_statewise.json"
